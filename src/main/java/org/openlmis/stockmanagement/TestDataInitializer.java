...
public class TestDataInitializer implements CommandLineRunner {
  ...
  static final String PHYSICAL_INVENTORY_LINE_ITEMS_TABLE = DB_SCHEMA + PHYSICAL_INVENTORY_LINE_ITEMS;
  static final String STOCK_CARD_LINE_ITEM_REASON_TAGS_TABLE = DB_SCHEMA + STOCK_CARD_LINE_ITEM_REASON_TAGS;
