...
import static org.openlmis.stockmanagement.i18n.MessageKeys.NOTIFICATION_LOWSTOCK_CONTENT;
import static org.openlmis.stockmanagement.i18n.MessageKeys.NOTIFICATION_LOWSTOCK_SUBJECT;
...
public class LowStockNotifier {
   ...
   */
  public void notifyStockEditors(StockCard stockCard, UUID rightId, double averageConsumption) {
    NotificationMessageParams params = new NotificationMessageParams(
        getMessage(NOTIFICATION_LOWSTOCK_SUBJECT),
        getMessage(NOTIFICATION_LOWSTOCK_CONTENT),
        constructSubstitutionMap(stockCard, averageConsumption));
    stockCardNotifier.notifyStockEditors(stockCard, rightId, params);
  }

  Map<String, String> constructSubstitutionMap(StockCard stockCard, double averageConsumption) {
