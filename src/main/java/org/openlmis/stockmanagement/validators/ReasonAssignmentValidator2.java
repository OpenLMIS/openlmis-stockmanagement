...
@Component(value = "ReasonAssignmentValidator2")
public class ReasonAssignmentValidator2 implements StockEventValidator2 {
  ...
  private void checkIsReasonInValidAssignmentList(StockEventDto2 stockEventDto,
