...
public class LotDeferredLoaderTest {
  ...
  public void shouldLoadAllLotsAsSingleCall() {
    final LotDeferredLoader loader = new LotDeferredLoader(lotReferenceDataService);
    ...
    verify(lotReferenceDataService, only()).findByIds(anyCollection());
  }
}
