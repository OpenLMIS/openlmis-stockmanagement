...
public class ProgramDeferredLoaderTest {
  ...
  public void shouldLoadAllLotsAsSingleCall() {
    final ProgramDeferredLoader loader = new ProgramDeferredLoader(programReferenceDataService);
    ...
    verify(programReferenceDataService, only()).findByIds(anyCollection());
  }
}
